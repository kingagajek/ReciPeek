...
<!--    <link rel="stylesheet" href="public\styles\welcome-mobile.css">-->
    <meta charset="UTF-8">
...
<body>
    <div class="main-container">
        ...
        <div class="buttons">
            <a href="register" class="button-bg-white">Create account</a>
            <a href="login" class="button-bg-clear">Sign in</a>
        </div>
    </div>
</body>
</html>